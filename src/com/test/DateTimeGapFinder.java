...
public class DateTimeGapFinder {
	...
	private List<Interval> removeNoneOverlappingIntervals(List<Interval> existingIntervals, Interval searchInterval) {
		...
		for (Interval interval : existingIntervals) {
			...
			if (interval.contains(searchInterval.getStart()) 
					|| interval.contains(searchInterval.getEnd())
					|| interval.getStart().equals(searchInterval.getStart()) 
					|| interval.getEnd().equals(searchInterval.getStart()) 
					|| interval.overlaps(searchInterval)
					|| interval.getStart().equals(searchInterval.getEnd()) 
					|| interval.getEnd().equals(searchInterval.getEnd())) {
